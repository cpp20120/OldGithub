...
namespace drogon {
template <> inline Articles fromRequest(const HttpRequest &req) {
...
auto ArticlesController::newArticle(
    Articles &&pNewArticle,
...
auto ArticlesController::getAllArticles(
    const HttpRequestPtr &req,
    std::function<void(const HttpResponsePtr &)> &&callback,
    const std::string &tag, const std::string &favorited,
    const std::string &author, int offset, int limit) -> void {
